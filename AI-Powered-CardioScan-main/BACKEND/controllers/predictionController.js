...
const predict = (req, res) => {
    ...
    // const model_path = "D:\AI-Powered-CardioScan-main\AI-Powered-CardioScan-main\MODELS\combineall.h5"

    console.log("Image Path:", imagePath);
    console.log("Model Path:", modelPath);

    console.log("tanisha is cute");
    console.log("jaya is cute",path.join(__dirname, '../scripts'));
